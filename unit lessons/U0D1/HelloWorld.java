...
// same colors = same things, system + helloworld both class, main + print behavior
...
public class HelloWorld {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("My name is Maia");

        System.out.print("My favorite cookie is chocolate chip. ");
        System.out.print("My favorite drinks are chocolate milk and iced chais. ");
        ...
        String myName = "maia"; // String is a CLASS not primitive data type
        ...
        if (appleCount == 5) {
            ...
            System.out.println("Eat more apples");
        }
